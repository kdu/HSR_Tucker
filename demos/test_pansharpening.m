...
figure(1)
subplot(2,2,1); imagesc(SRI(:,:,150)); ...
    title('Groundtruth'); colorbar; lim = caxis; axis off
subplot(2,2,2); imagesc(real(est{1}(:,:,150)));...
    title(sprintf('%s, R=%s',methods{1,1},methods{1,3})); colorbar; caxis(lim); axis off
subplot(2,2,3); imagesc(real(est{2}(:,:,150)));...
    title(sprintf('%s, R=%s',methods{2,1},methods{2,3})); colorbar; caxis(lim); axis off
subplot(2,2,4); imagesc(real(est{3}(:,:,150)));...
