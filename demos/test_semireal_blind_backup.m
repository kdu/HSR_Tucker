...
X(:,:,[1:2 104:113 148:167 221:224]) = []; %Regions of water absorption
...
tic; [Xhat2,~] = scuba(MSI,HSI,Pm, [45,3], opts); t2 = toc;
tic; [Xhat3,~] = bscott(MSI,HSI,Pm, [45,45,3], opts); t3 = toc;

tic; [Xhat4,~] = scuba(MSI,HSI,Pm, [140,10], opts2); t4 = toc;
tic; [Xhat5,~] = bscott(MSI,HSI,Pm, [150,150,6], opts2); t5 = toc;

tic; [Xhat6,~] = scuba(MSI,HSI,Pm, [45,3], opts3); t6 = toc;
tic; [Xhat7,~] = bscott(MSI,HSI,Pm, [45,45,3], opts3); t7 = toc;
