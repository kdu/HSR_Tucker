...
% 1. abundance maps
I = 120; J = 120; g1 = fspecial('gaussian',20, 5); %spatial dimensions
A1 = zeros(I,J); A2 = A1; A3 = A1; A4 = A1; A5 = A1; A6 = A1; %init. maps

A1(1:20,1:20) = g1; A2(21:40,21:40) = g1; A3(41:60,41:60) = g1;
A4(61:80,61:80) = g1; A5(81:100,81:100) = g1; A6(101:120,101:120) = g1;
